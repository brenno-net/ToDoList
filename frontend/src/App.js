    ...
    <div className="App">
      ...
      <div class="header">
        ...
        <nav className="navbar">
          <button
            className={currentPage === 'todo' ? 'button active' : 'button'}
        ...
        {currentPage === 'pomodoro' && (
          <div className="pomodoro-container">
            ...
            <div className="pomodoro-text-box">
              <div>
                O Método Pomodoro é uma técnica de produtividade baseada em intervalos de trabalho curtos, geralmente de
                25 minutos, seguidos por breves pausas de 5 minutos. Ajuda a manter o foco, aumentar a eficiência e
